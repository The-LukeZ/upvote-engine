/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d0a0ca9ecbbddeaefd25c35aba2fadad)
...
declare namespace Cloudflare {
	...
	interface Env {
		vote_handler: D1Database;
		VOTE_APPLY: Queue;
		VOTE_REMOVE: Queue;
		FORWARD_WEBHOOK: Queue;
		RATELIMITER_FORWARDING_TEST: RateLimit;
		ASSETS: Fetcher;
		...
		TOP_GG_TOKEN: string;
		BLACKLIST: DurableObjectNamespace<import("./src/index").BlacklistCacheDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_APPLICATION_ID" | "DISCORD_PUBLIC_KEY" | "DISCORD_TOKEN" | "DISCORD_APP_SECRET" | "ENCRYPTION_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "OWNER_ID" | "ADMIN_GUILD_ID" | "TOP_GG_TOKEN">> {}
}
